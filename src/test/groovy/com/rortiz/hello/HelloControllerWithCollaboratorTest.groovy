...
class HelloControllerWithCollaboratorTest extends Specification {

    def mapper = Mock(Mapper)
    def controller = new HelloControllerWithCollaborator(mapper)
    ...
    def "Greeting case for get endpoint"() {
        ...
        then:
            1 * mapper.mapToCode(greet) >> HelloResponseDto.Code.OK
            1 * mapper.mapToMessage(greet) >> Mapper.HELLO_MESSAGE
        and: "The response is an OK response as expected"
